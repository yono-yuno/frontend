    ...
    <div className="flex flex-col h-full relative">
      ...
      >
        ...
        <div className="px-4 py-2">
          ...
          <p className="text-sm text-gray-400 line-through font-PDMedium">
            16,500원
          </p>
          ...
          <div className="flex justify-start items-center">
            <p className="p-1 bg-gray-100 rounded-md text-[10px] font-PDMedium">
              무료배송
            </p>
          </div>
      ...
      <div className="absolute bottom-0 flex justify-center items-center h-40 w-full bg-gradient-to-b from-transparent to-white from-10% to-20%">
        <Button text="구매하기" />
      </div>
    </div>
  );
